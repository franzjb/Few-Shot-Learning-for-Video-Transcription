...
def main(device, src, option=None):
    ...
    model_path = download_asset("/home/frb6002/Documents/experiments/online_model/train_1/last.ckpt")
    spm_model_path = download_asset("/home/frb6002/Documents/lipreading_fsl/audio/examples/avsr/data_prep/sentencepiece/spm_model3.model")
